...
export const DecoratedText = styled.div(
  (props: any) => css`
    ...
    ${R.setDeskTopStyle(css`
      font-size: ${props.style.fontSize === 'sp' ? `${S.DeskTopFontSizeSupper}rem` : ''}
        ${props.style.fontSize === 'lg' ? `${S.DeskTopFontSizeLg}rem` : ''}
        ${props.style.fontSize === 'md' ? `${S.DeskTopFontSizeMiddle}rem` : ''};
    `)}

    ${R.setNoteBookStyle(css`
      font-size: ${props.style.fontSize === 'sp' ? `${S.NoteBookFontSizeSupper}rem` : ''}
    ...
    ${R.setBigTabletStyle(css`
      font-size: ${props.style.fontSize === 'sp' ? `${S.BigTabletFontSizeSupper}rem` : ''}
    ...
    ${R.setSmallTabletStyle(css`
      font-size: ${props.style.fontSize === 'sp' ? `${S.SmallTabletFontSizeSupper}rem` : ''}
    ...
    ${R.setMobileStyle(css`
      font-size: ${props.style.fontSize === 'sp' ? `${S.MobileFontSizeSupper}rem` : ''}
